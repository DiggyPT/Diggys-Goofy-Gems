...
public class GenerateOresBro implements IWorldGenerator {
			...
			IChunkProvider chunkProvider)
	{
		...
		generateOre(BlockInit.ORE_RUBY.getDefaultState(), world, random, chunkX * 16, chunkZ * 16, 4, 56, Config.rubyChances);
		generateOre(BlockInit.ORE_SAPPHIRE.getDefaultState(), world, random, chunkX * 16, chunkZ * 16, 9, 78, Config.sapphireChances);
		generateOre(BlockInit.ORE_TANZANITE.getDefaultState(), world, random, chunkX * 16, chunkZ * 16, 4, 56, Config.tanzaniteChances);
