...
public class Config {
	 private static final String CATEGORY_GENERAL = "general";
	    ...
	    private static void initGeneralConfig(Configuration cfg) {
	        ...
	        rubyChances = cfg.getInt("sapphireChances", CATEGORY_GENERAL, sapphireChances, 0, 32, "Amount of sapphire ores that appear per chunk");
	        rubyChances = cfg.getInt("tanzaniteChances", CATEGORY_GENERAL, tanzaniteChances, 0, 32, "Amount of tanzanite ores that appear per chunk");
	    }
}